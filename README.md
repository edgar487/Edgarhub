...
if not success then
    warn("Delta Hub: Erro ao criar GUI - " .. tostring(result))
    
    local backupGui = Instance.new("ScreenGui")
    backupGui.Name = "DeltaHub_Backup"
    backupGui.Parent = CoreGui
    
    local errorMsg = Instance.new("TextLabel")
    errorMsg.Size = UDim2.new(0, 300, 0, 50)
    errorMsg.Position = UDim2.new(0.5, -150, 0.5, -25)
    errorMsg.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    errorMsg.BackgroundTransparency = 0.3
    errorMsg.Text = "⚠️ Clique para abrir o Hub"
    errorMsg.TextColor3 = Color3.fromRGB(255, 255, 255)
    errorMsg.TextSize = 16
    errorMsg.Font = Enum.Font.GothamBold
    errorMsg.Parent = backupGui
    
    local errorCorner = Instance.new("UICorner")
    errorCorner.CornerRadius = UDim.new(0, 10)
    errorCorner.Parent = errorMsg
    
    errorMsg.MouseButton1Click:Connect(function()
        backupGui:Destroy()
        pcall(createGUI)
    end)
end
